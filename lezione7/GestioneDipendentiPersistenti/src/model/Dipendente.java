...
public class Dipendente {
	...
	public String toString() {
		return "Dipendente [id=" + id + ", nome=" + nome + ", cognome=" + cognome + ", luogoDiNascista="
				+ luogoDiNascista + ", dataDiNascita=" + dataDiNascita + ", sesso=" + sesso + ", stipendio=" + stipendio
				+ ", account=" + idAccount + ", ruoloAziendale=" + idRuoloAziendale + ", codiceFiscale=" + codiceFiscale
				+ "]";
	}
